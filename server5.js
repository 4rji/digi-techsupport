...
// Función para cargar las VMs del servidor 5
async function loadServer5VMs() {
  console.log('Attempting to load VMs for server5...');
  try {
...
// Exportar funciones específicas del servidor 5
export {
  loadServer5VMs,
  SERVER_ID
}; 